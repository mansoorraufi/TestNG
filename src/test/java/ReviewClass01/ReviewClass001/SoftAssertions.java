...
//        assertion
        ...
        System.out.println("After all the assertions, Iam sending tis message");
//  assert all the assertions that have been made
        soft.assertAll(); // it gives an idea how many test cases are passed and failed.
//      this should be the last statement of you test case, nothing should be executed after
    }
